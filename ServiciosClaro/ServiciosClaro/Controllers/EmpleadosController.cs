...
namespace ServiciosClaro.Controllers
{
    ...
    {
        private ServiciosClaroContext db = new ServiciosClaroContext();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Telefono,IdPuesto,Email,Cedula,FechaContratacion,IdCuenta")] Empleado empleado)
        {
            if (ModelState.IsValid)
            {
