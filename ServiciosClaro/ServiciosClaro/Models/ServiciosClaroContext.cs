...
{
    public class ServiciosClaroContext : DbContext
    {
        ...
        public ServiciosClaroContext() : base("name=ServiciosClaroContext")
        {
        }

        public System.Data.Entity.DbSet<ServiciosClaro.Models.Cuenta> Cuentas { get; set; }
